...
def prepare_enviroment():
    ...
    magicprompt_repo = os.environ.get('MAGICPROMPT_REPO', 'https://huggingface.co/Gustavosta/MagicPrompt-Stable-Diffusion')
    ...
    magicprompt_commit_hash = os.environ.get('MAGICPROMPT_COMMIT_HASH', "3b95df27d34309fd1bfa0808acd2d2e8b3f4cc14")
    ...
    git_clone(magicprompt_repo, repo_dir('MagicPrompt-Stable-Diffusion'), "MagicPrompt", magicprompt_commit_hash)
