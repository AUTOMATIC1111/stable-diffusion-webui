...
4. Place Stable Diffusion models/checkpoints you want to use to `stable-diffusion-webui/models/Stable-diffusion`. If you don't have any, see [Downloading Stable Diffusion Models](https://github.com/AUTOMATIC1111/stable-diffusion-webui/wiki/Installation-on-Apple-Silicon/_edit#downloading-stable-diffusion-models) below.
...
* [Stable DIffusion 1.4](https://huggingface.co/CompVis/stable-diffusion-v-1-4-original) (Download `sd-v1-4.ckpt`)
