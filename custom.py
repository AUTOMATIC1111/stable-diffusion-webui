...
def highRes():
       os.system('git clone https://github.com/klimaleksus/stable-diffusion-webui-conditioning-highres-fix.git')

def twoShot():
       os.system('git clone https://github.com/opparco/stable-diffusion-webui-two-shot.git')

def composableLora():
       os.system('git clone https://github.com/opparco/stable-diffusion-webui-composable-lora.git')

def locon():
       os.system('git clone https://github.com/KohakuBlueleaf/a1111-sd-webui-locon.git')
