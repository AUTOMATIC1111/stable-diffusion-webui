...
RUN https_proxy=${HTTP_PROXY} git clone https://github.com/AlUlkesh/stable-diffusion-webui-images-browser /root/stable-diffusion-webui/extensions/images-browser
