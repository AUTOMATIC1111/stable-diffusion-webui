...
let ze
function Zt(t, e) {
  return ze || (ze = document.createElement('a')), (ze.href = e), t === ze.href
}
function Pl(t) {
...
function Wl(t, e, n, r, o, a, i, s, d, l, c, p) {
  ...
  const g = new Set(),
    m = new Set()
  function C(w) {
    j(w, 1), w.m(s, c), i.set(w.key, w), (c = w.first), u--
  }
  for (; f && u; ) {
    const w = x[u - 1],
      E = t[f - 1],
...
function Gs(t, e) {
  return Hn(t, this, zo, e.cache.create(), e.serializer)
}
var Vs = function () {
...
const bd = 'modulepreload',
  ...
  hd = {
    accordion: () =>
      G(() => import('./index.39a00db2.js'), [
        'assets/index.39a00db2.js',
        'assets/Column.5eb13a8d.js',
      ]),
    audio: () =>
      G(() => import('./index.eb7775de.js'), [
        'assets/index.eb7775de.js',
        'assets/index.712d6db6.css',
        'assets/Upload.7fd2c50a.js',
        'assets/ModifyUpload.713b1a15.js',
        'assets/BlockLabel.dc20a993.js',
        'assets/utils.27234e1d.js',
      ]),
    box: () => G(() => import('./index.483d57eb.js'), []),
    button: () => G(() => import('./index.b434f24a.js'), []),
    carousel: () =>
      G(() => import('./index.44c98869.js'), [
        'assets/index.44c98869.js',
        'assets/CarouselItem.svelte_svelte_type_style_lang.82fe7c76.js',
        'assets/CarouselItem.svelte_svelte_type_style_lang.e110d966.css',
      ]),
    carouselitem: () =>
      G(() => import('./index.c5b13457.js'), [
        'assets/index.c5b13457.js',
        'assets/CarouselItem.svelte_svelte_type_style_lang.82fe7c76.js',
        'assets/CarouselItem.svelte_svelte_type_style_lang.e110d966.css',
      ]),
    chatbot: () =>
      G(() => import('./index.8e39e523.js'), [
        'assets/index.8e39e523.js',
        'assets/index.72f44ebf.css',
        'assets/BlockLabel.dc20a993.js',
      ]),
    checkbox: () => G(() => import('./index.7ccc1ccb.js'), []),
    checkboxgroup: () => G(() => import('./index.5309e46d.js'), []),
    colorpicker: () => G(() => import('./index.576e2809.js'), []),
    column: () =>
      G(() => import('./index.503a89eb.js'), [
        'assets/index.503a89eb.js',
        'assets/Column.5eb13a8d.js',
      ]),
    dataframe: () =>
      G(() => import('./index.81ef6c10.js'), [
        'assets/index.81ef6c10.js',
        'assets/Upload.7fd2c50a.js',
        'assets/dsv.7fe76a93.js',
      ]),
    dataset: () =>
      G(() => import('./index.882bbdb5.js'), [
        'assets/index.882bbdb5.js',
        'assets/Image.1994183a.js',
        'assets/csv.27f5436c.js',
        'assets/dsv.7fe76a93.js',
        'assets/Model3D.48ad65ad.js',
      ]),
    dropdown: () => G(() => import('./index.67107e61.js'), []),
    file: () =>
      G(() => import('./index.0c91e605.js'), [
        'assets/index.0c91e605.js',
        'assets/BlockLabel.dc20a993.js',
        'assets/File.679247a3.js',
        'assets/Upload.7fd2c50a.js',
        'assets/ModifyUpload.713b1a15.js',
        'assets/utils.27234e1d.js',
      ]),
    form: () => G(() => import('./index.4364eebe.js'), []),
    gallery: () =>
      G(() => import('./index.2c37f7a1.js'), [
        'assets/index.2c37f7a1.js',
        'assets/index.10851bbc.css',
        'assets/BlockLabel.dc20a993.js',
        'assets/ModifyUpload.713b1a15.js',
        'assets/utils.27234e1d.js',
        'assets/Image.188057d0.js',
      ]),
    group: () =>
      G(() => import('./index.8cbfad5e.js'), [
        'assets/index.8cbfad5e.js',
        'assets/index.803c5e11.css',
      ]),
    highlightedtext: () =>
      G(() => import('./index.9a6bd3f2.js'), [
        'assets/index.9a6bd3f2.js',
        'assets/index.7a93f874.css',
        'assets/color.2f443c47.js',
        'assets/BlockLabel.dc20a993.js',
      ]),
    html: () => G(() => import('./index.bd13ea82.js'), []),
    image: () =>
      G(() => import('./index.3e3c6920.js'), [
        'assets/index.3e3c6920.js',
        'assets/BlockLabel.dc20a993.js',
        'assets/Image.188057d0.js',
        'assets/Webcam.cd37ad30.js',
        'assets/ModifyUpload.713b1a15.js',
        'assets/Upload.7fd2c50a.js',
        'assets/Image.1994183a.js',
      ]),
    interpretation: () =>
      G(() => import('./index.6fddc911.js'), [
        'assets/index.6fddc911.js',
        'assets/index.64cd2c53.css',
      ]),
    json: () =>
      G(() => import('./index.beffe5bc.js'), [
        'assets/index.beffe5bc.js',
        'assets/BlockLabel.dc20a993.js',
      ]),
    label: () =>
      G(() => import('./index.87c5d749.js'), [
        'assets/index.87c5d749.js',
        'assets/BlockLabel.dc20a993.js',
      ]),
    markdown: () =>
      G(() => import('./index.c6f5e6dd.js'), [
        'assets/index.c6f5e6dd.js',
        'assets/index.1a9e15aa.css',
      ]),
    model3d: () =>
      G(() => import('./index.ad87d374.js'), [
        'assets/index.ad87d374.js',
        'assets/utils.27234e1d.js',
        'assets/BlockLabel.dc20a993.js',
        'assets/File.679247a3.js',
    ...
    number: () => G(() => import('./index.ff25482c.js'), []),
    plot: () =>
      G(() => import('./index.9a09a488.js'), [
        'assets/index.9a09a488.js',
        'assets/_commonjsHelpers.d2428edb.js',
        'assets/color.2f443c47.js',
    ...
    radio: () => G(() => import('./index.3603cd5a.js'), []),
    row: () => G(() => import('./index.40c24c5e.js'), []),
    slider: () => G(() => import('./index.e6bb2d3a.js'), []),
    state: () => G(() => import('./index.4809f2a4.js'), []),
    statustracker: () => G(() => import('./index.2c7aef33.js'), []),
    tabs: () =>
      G(() => import('./index.bce254d6.js'), [
        'assets/index.bce254d6.js',
        'assets/Tabs.58549a69.js',
        'assets/Column.5eb13a8d.js',
      ]),
    tabitem: () =>
      G(() => import('./index.6b06893a.js'), [
        'assets/index.6b06893a.js',
        'assets/Tabs.58549a69.js',
        'assets/Column.5eb13a8d.js',
      ]),
    textbox: () => G(() => import('./index.d3a45d32.js'), []),
    timeseries: () =>
      G(() => import('./index.569d9026.js'), [
        'assets/index.569d9026.js',
        'assets/Upload.7fd2c50a.js',
        'assets/ModifyUpload.713b1a15.js',
        'assets/BlockLabel.dc20a993.js',
        'assets/color.2f443c47.js',
    ...
    uploadbutton: () =>
      G(() => import('./index.0f1dbc9b.js'), [
        'assets/index.0f1dbc9b.js',
        'assets/_commonjsHelpers.d2428edb.js',
      ]),
    video: () =>
      G(() => import('./index.87d3770d.js'), [
        'assets/index.87d3770d.js',
...
function fr(t) {
  ...
  return {
    ...
    i(s) {
      if (!o) {
        for (let d = 0; d < a.length; d += 1) j(e[d])
        o = !0
      }
    },
    o(s) {
  ...
  return {
    ...
    p(o, a) {
      o[1] && o[1].length
        ? r
          ? (r.p(o, a), a & 2 && j(r, 1))
          : ((r = fr(o)), r.c(), j(r, 1), r.m(e.parentNode, e))
        : r &&
          (Ct(),
          V(r, 1, 1, () => {
            r = null
...
var _l = './static/img/api-logo.svg',
  yl = './static/img/clear.svg',
  hr = './static/img/python.svg',
  _r = './static/img/javascript.svg'
function yr(t, e, n) {
  const r = t.slice()
...
function vc(t) {
  ...
  return {
    ...
    p(w, E) {
      if (
        ...
        for (k = 0; k < g.length; k += 1) {
          ...
          m[k]
            ? (m[k].p(Z, E), j(m[k], 1))
            : ((m[k] = Mr(Z)), m[k].c(), j(m[k], 1), m[k].m(h, null))
        }
    ...
    i(w) {
      if (!S) {
        for (let E = 0; E < g.length; E += 1) j(m[E])
        S = !0
      }
    },
    o(w) {
...
function Ar(t) {
  ...
  let ee = t[19].inputs,
    ut = []
  for (let z = 0; z < ee.length; z += 1) ut[z] = Cr(Sr(t, ee, z))
  let ne = t[19].outputs,
    ft = []
  for (let z = 0; z < ne.length; z += 1) ft[z] = Pr(Er(t, ne, z))
  let at = t[5] && Or(),
    dn = [
      ['python', hr],
      ['javascript', _r],
    ...
    Nt = []
  for (let z = 0; z < 2; z += 1) Nt[z] = Lr(kr(t, dn, z))
  function Qn(z, it) {
    if (z[3] === 'python') return Tc
    if (z[3] === 'javascript') return Ac
    if (z[3] === 'gradio client') return Sc
  }
  let re = Qn(t),
    mt = re && re(t)
  return {
    c() {
      ;(e = A('div')),
        ...
        (k = A('br')),
        (Z = R())
      for (let z = 0; z < ut.length; z += 1) ut[z].c()
      ;(L = P(`
						\xA0\xA0]`)),
        (rt = A('br')),
        (X = P(`
        ...
        (Re = A('br')),
        (Me = R())
      for (let z = 0; z < ft.length; z += 1) ft[z].c()
      ;(I = P(`
							\xA0\xA0\xA0\xA0],`)),
        (D = A('br')),
        ($ = P(`
    ...
    p(z, it) {
      if (
        ...
        zt !== (zt = Gt(t)) &&
          (Lt.d(1), (Lt = zt(t)), Lt && (Lt.c(), Lt.m(x, null))),
        it[0] & 326)
      ) {
        ee = t[19].inputs
        let M
      ...
      if (
        ...
        t[5]
          ? at
            ? it[0] & 32 && j(at, 1)
            : ((at = Or()), at.c(), j(at, 1), at.m(At, null))
          : at &&
            (Ct(),
            V(at, 1, 1, () => {
              at = null
    ...
    p(F, U) {
      ;(t = F),
        ...
        U[0] & 6 &&
          ...
          Y(h, u),
        U[0] & 6 && x !== (x = jr(t[1][t[30]].props.label) + '') && Y(O, x),
    ...
    p(E, k) {
      E[7][E[21]][E[24]] !== void 0
        ...
        k[0] & 6 &&
          ...
          Y(p, c),
        k[0] & 6 && u !== (u = zr(E[1][E[30]].props.label) + '') && Y(h, u),
  ...
  return {
    ...
    p(o, a) {
      o[19].api_name
        ? r
          ? (r.p(o, a), a[0] & 4 && j(r, 1))
          : ((r = Ar(o)), r.c(), j(r, 1), r.m(e.parentNode, e))
        : r &&
          (Ct(),
          V(r, 1, 1, () => {
            r = null
...
var Oc = './assets/logo.0a070fcf.svg'
function Fr(t) {
  ...
  return {
    ...
    p(C, w) {
      C[6]
        ...
        C[12]
          ? T
            ? (T.p(C, w), w[0] & 4096 && j(T, 1))
            : ((T = Ur(C)), T.c(), j(T, 1), T.m(a, null))
          : T &&
            (Ct(),
            V(T, 1, 1, () => {
              T = null
        ...
        C[10] && C[12]
          ? m
            ? (m.p(C, w), w[0] & 5120 && j(m, 1))
            : ((m = Vr(C)), m.c(), j(m, 1), m.m(h.parentNode, h))
          : m &&
            (Ct(),
            V(m, 1, 1, () => {
              m = null
  ...
  async function At() {
    ...
    d.forEach(
      (
        ...
        const je = $.map((nt) => [nt, L[nt]])
        if (
          $.length === 0 &&
          !yt[lt]?.includes(-1) &&
          Q === 'load' &&
          jt.every((nt) => L?.[nt].instance) &&
          ...
          let Ut = function (st) {
            st.data.forEach((xt, dt) => {
              if (
                ...
                for (const [Gt, zt] of Object.entries(xt))
                  Gt !== '__type__' && n(11, (L[jt[dt]].props[Gt] = zt), L)
                n(9, m)
              } else n(11, (L[jt[dt]].props.value = xt), L)
            })
          }
          const nt = a({
            action: 'predict',
        ...
        je.filter((nt) => !!nt && !!nt[1]).forEach(([nt, { instance: Ut }]) => {
          ...
          Ut?.$on(Q, () => {
            ...
            const xt = a({
              ...
              output_data: jt.map((dt) => L[dt].props.value),
              queue: vt === null ? l : vt,
              queue_callback: st,
              loading_status: g,
              cancels: Ht,
          ...
          function st(xt) {
            xt.data.forEach((dt, Gt) => {
              if (
                ...
                n(9, m)
              } else n(11, (L[jt[Gt]].props.value = dt), L)
            })
          }
  ...
  return {
    ...
    p(a, [i]) {
      o &&
        o.p &&
        (!n || i & 1) &&
        Fn(o, r, a, a[0], n ? zn(r, a[0], i, null) : Dn(a[0]), null)
    },
    i(a) {
      n || (j(o, a), (n = !0))
    },
  ...
  return {
    ...
    p(l, c) {
      i &&
        i.p &&
        (!o || c & 16384) &&
        Fn(i, a, l, l[14], o ? zn(a, l[14], c, null) : Dn(l[14]), null),
        $n(
          e,
          (d = Bn(s, [
  ...
  return {
    ...
    p(a, [i]) {
      o &&
        o.p &&
        (!n || i & 2) &&
        Fn(o, r, a, a[1], n ? zn(r, a[1], i, null) : Dn(a[1]), null),
        i & 1 && q(e, 'sr-only', !a[0]),
        i & 1 && q(e, 'h-0', !a[0]),
        i & 1 && q(e, '!m-0', !a[0])
    },
...
function d0(t) {
  ...
  return {
    ...
    p(a, i) {
      a[13]
        ? o
          ? (o.p(a, i), i[0] & 8192 && j(o, 1))
          : ((o = Zr(a)), o.c(), j(o, 1), o.m(r.parentNode, r))
        : o && (o.d(1), (o = null))
    },
    i(a) {
      j(o)
  ...
  return (
    ...
    n.$on('blur', t[15]),
    {
      ...
      p(d, l) {
        d[10]
          ? a
            ? (a.p(d, l), l & 1024 && j(a, 1))
            : ((a = lo(d)), a.c(), j(a, 1), a.m(e.parentNode, e))
          : a &&
            (Ct(),
            V(a, 1, 1, () => {
              a = null
...
function S0(t) {
  ...
  return (
    ...
    o.$on('submit', t[5]),
    {
      ...
      i(p) {
        i || (j(e.$$.fragment, p), j(o.$$.fragment, p), (i = !0))
      },
      o(p) {
...
const P0 = './assets/index.bdc96d69.css',
  O0 = [
