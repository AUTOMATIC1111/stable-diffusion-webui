...
onLoad(function(){
    ...
    appendContextMenuOption('#txt2img_generate',I18N("Generate forever"),function(){
        generateOnRepeat('#txt2img_generate','#txt2img_interrupt');
    });
    appendContextMenuOption('#img2img_generate',I18N("Generate forever"),function(){
    ...
    appendContextMenuOption('#txt2img_interrupt',I18N("Cancel generate forever"),cancelGenerateForever);
    appendContextMenuOption('#txt2img_generate', I18N("Cancel generate forever"),cancelGenerateForever);
    appendContextMenuOption('#img2img_interrupt',I18N("Cancel generate forever"),cancelGenerateForever);
    appendContextMenuOption('#img2img_generate', I18N("Cancel generate forever"),cancelGenerateForever);

    appendContextMenuOption('#roll',I18N("Roll three"),
        function(){ 
