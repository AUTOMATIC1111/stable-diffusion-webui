...
titles = {
    ...
    "Images filename pattern": "Use following tags to define how filenames for images are chosen: [steps], [cfg], [prompt], [prompt_no_styles], [prompt_spaces], [prompt_words], [width], [height], [styles], [sampler], [seed], [model_hash], [date], [datetime], [job_timestamp]; leave empty for default.",
    "Directory name pattern": "Use following tags to define how subdirectories for images and grids are chosen: [steps], [cfg], [prompt], [prompt_no_styles], [prompt_spaces], [prompt_words], [width], [height], [styles], [sampler], [seed], [model_hash], [date], [datetime], [job_timestamp]; leave empty for default.",
