...
export COMMANDLINE_ARGS="--port 3000 --xformers --api --api-auth bashable:g46tTaGtrU3hAfmMbgNq --api-log --nowebui --ckpt /workspace/stable-diffusion-webui/models/Stable-diffusion/deliberate_v2.safetensors --listen --enable-insecure-extension-access --share"
