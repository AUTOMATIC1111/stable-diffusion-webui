...
def train(args, callback):
    ...
    for epoch in range(num_train_epochs):
        ...
        if callback is not None:
            callback(epoch, loss_total / len(loss_list))
...
def train_db_with_params(pretrained_model_name_or_path, train_data_dir, reg_data_dir, output_name,
                      ...
                      seed=42,
                      caption_extension=".txt", output_dir="./output",
                      logging_dir="./logs", save_last_n_epochs=2, lr_scheduler_num_cycles=1,
    ...
    args.list_train_data_dir = list_train_data_dir
    ...
    args.color_aug = color_aug
    args.flip_aug = flip_aug
