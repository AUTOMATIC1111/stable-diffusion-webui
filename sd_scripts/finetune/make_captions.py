...
def make_caption_with_blip(
    ...
    if not os.path.exists("blip"):
        train_data_dir = os.path.abspath(train_data_dir)  # convert to absolute path

        cwd = os.getcwd()
        print("Current Working Directory is: ", cwd)
        os.chdir("finetune")

    print(f"load images from {train_data_dir}")
        ...
        with torch.no_grad():
            ...
            if False:
                captions = model.generate(
                    imgs, sample=False, num_beams=num_beams, max_length=max_length, min_length=min_length
                )
            else:
                captions = model.generate(
                    imgs, sample=True, top_p=top_p, max_length=max_length, min_length=min_length
                )
...
#     args.train_data_dir = "/data/qll/pics/segpics/everything"
#     args.caption_weights = "/data/qll/blip_models/model_large_caption.pth"
...
#     args.caption_weights=caption_weights
...
if __name__ == "__main__":
    train_data_dir = "/data/qll/pics/segpics/everything"
    caption_weights = "/data/qll/blip_models/model_large_caption.pth"
    caption_extension=".txt"

    make_caption_with_blip(train_data_dir=train_data_dir,caption_weights=caption_weights,caption_extension=caption_extension)
