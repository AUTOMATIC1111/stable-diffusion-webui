...
class AxisOption:
    def __init__(self, label, type, apply, format_value_func=format_value_add_label, confirm=None, cost=0.0, choices=None, prepare=None):
        self.label = label
        self.type = type
        self.apply = apply
        self.format_value = format_value_func
