...
from modules.processing import Processed  # Corrected import name
from modules.shared import cmd_opts


def convert_expr_to_expression(expr):
    """
    Convert an ast.Expr to ast.Expression.
    """
    expr.lineno = 0
    expr.col_offset = 0
...
def exec_with_return(code, module):
    ...
    See: https://stackoverflow.com/a/52361938/5862977
    """
    ...
    if isinstance(last_ast.body[0], ast.Expr):
        return eval(compile(convert_expr_to_expression(last_ast.body[0]), "<ast>", "eval"), module.__dict__)
    else:
