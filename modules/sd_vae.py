...
def refresh_vae_list():
    ...
    paths = [
        ...
        os.path.join(sd_models.user_models_path, 'VAE/*.vae.ckpt'),
        os.path.join(sd_models.user_models_path, 'VAE/*.vae.pt'),
        os.path.join(sd_models.user_models_path, 'VAE/*.vae.safetensors')
    ]
