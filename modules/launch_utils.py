...
This program supports Python 3.10 through 3.12 on Windows and Python 3.7 through 3.12 on Linux/macOS, but you have {major}.{minor}.{micro}.
If you encounter an error with "RuntimeError: Couldn't install torch." message,
or any other error regarding unsuccessful package (library) installation,
please install Python 3.12, delete the "venv" folder in WebUI's directory,
...
def prepare_environment():
    ...
    torch_command = os.environ.get('TORCH_COMMAND', f"pip install torch==2.4.1 torchvision==0.19.1 --extra-index-url {torch_index_url}")
    if args.use_ipex:
