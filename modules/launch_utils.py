# this scripts installs necessary requirements and launches main program in bard.py
import logging
import re
import subprocess
import os
...
{"Alternatively, use a binary release of WebUI: www.google.com" if is_windows else ""}
