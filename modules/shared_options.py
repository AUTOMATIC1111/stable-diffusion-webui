...
options_templates.update(options_section(('upscaling', "Upscaling", "postprocessing"), {
    ...
    "HAT_tile": OptionInfo(192, "Tile size for HAT upscalers.", gr.Slider, {"minimum": 0, "maximum": 512, "step": 16}).info("0 = no tiling"),
    "HAT_tile_overlap": OptionInfo(8, "Tile overlap for HAT upscalers.", gr.Slider, {"minimum": 0, "maximum": 48, "step": 1}).info("Low values = visible seam"),
    "SRFormer_tile": OptionInfo(192, "Tile size for SRFormer upscalers.", gr.Slider, {"minimum": 0, "maximum": 512, "step": 16}).info("0 = no tiling"),
    "SRFormer_tile_overlap": OptionInfo(8, "Tile overlap for SRFormer upscalers.", gr.Slider, {"minimum": 0, "maximum": 48, "step": 1}).info("Low values = visible seam"),
    "GRL_tile": OptionInfo(192, "Tile size for GRL upscalers.", gr.Slider, {"minimum": 0, "maximum": 512, "step": 16}).info("0 = no tiling"),
    "GRL_tile_overlap": OptionInfo(8, "Tile overlap for GRL upscalers.", gr.Slider, {"minimum": 0, "maximum": 48, "step": 1}).info("Low values = visible seam"),
    "OmniSR_tile": OptionInfo(192, "Tile size for OmniSR upscalers.", gr.Slider, {"minimum": 0, "maximum": 512, "step": 16}).info("0 = no tiling"),
    "OmniSR_tile_overlap": OptionInfo(8, "Tile overlap for OmniSR upscalers.", gr.Slider, {"minimum": 0, "maximum": 48, "step": 1}).info("Low values = visible seam"),
    "SPAN_tile": OptionInfo(192, "Tile size for SPAN upscalers.", gr.Slider, {"minimum": 0, "maximum": 512, "step": 16}).info("0 = no tiling"),
    "SPAN_tile_overlap": OptionInfo(8, "Tile overlap for SPAN upscalers.", gr.Slider, {"minimum": 0, "maximum": 48, "step": 1}).info("Low values = visible seam"),
    "COMPACT_tile": OptionInfo(192, "Tile size for COMPACT upscalers.", gr.Slider, {"minimum": 0, "maximum": 512, "step": 16}).info("0 = no tiling"),
    "COMPACT_tile_overlap": OptionInfo(8, "Tile overlap for COMPACT upscalers.", gr.Slider, {"minimum": 0, "maximum": 48, "step": 1}).info("Low values = visible seam"),
