...
options_templates.update(options_section(('compatibility', "Compatibility", "sd"), {
    ...
    "use_downcasted_alpha_bar": OptionInfo(False, "Downcast model alphas_cumprod to fp16 before sampling. For reproducing old seeds.")
}))
...
options_templates.update(options_section(('sampler-params', "Sampler parameters", "sd"), {
    ...
    'sd_noise_schedule': OptionInfo("Default", "Noise schedule for sampling", gr.Radio, {"choices": ["Default", "Zero Terminal SNR"]}, infotext="Noise schedule for sampling").info("for use with zero terminal SNR trained models")
}))
