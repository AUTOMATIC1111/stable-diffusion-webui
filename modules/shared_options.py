...
options_templates.update(options_section(('saving-paths', "Paths for saving", "saving"), {
    ...
    "outdir_txt2img_samples": OptionInfo(f"{shared.cmd_opts.data_dir}/outputs/txt2img-images", 'Output directory for txt2img images', component_args=hide_dirs),
    "outdir_img2img_samples": OptionInfo(f"{shared.cmd_opts.data_dir}/outputs/img2img-images", 'Output directory for img2img images', component_args=hide_dirs),
    "outdir_extras_samples": OptionInfo(f"{shared.cmd_opts.data_dir}/outputs/extras-images", 'Output directory for images from extras tab', component_args=hide_dirs),
    "outdir_grids": OptionInfo("", "Output directory for grids; if empty, defaults to two directories below", component_args=hide_dirs),
    "outdir_txt2img_grids": OptionInfo(f"{shared.cmd_opts.data_dir}/outputs/txt2img-grids", 'Output directory for txt2img grids', component_args=hide_dirs),
    "outdir_img2img_grids": OptionInfo(f"{shared.cmd_opts.data_dir}/outputs/img2img-grids", 'Output directory for img2img grids', component_args=hide_dirs),
    "outdir_save": OptionInfo(f"{shared.cmd_opts.data_dir}/log/images", "Directory for saving images using the Save button", component_args=hide_dirs),
    "outdir_init_images": OptionInfo(f"{shared.cmd_opts.data_dir}/outputs/init-images", "Directory for saving init images when using img2img", component_args=hide_dirs),
}))
