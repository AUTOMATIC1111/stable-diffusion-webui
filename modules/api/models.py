...
class PydanticModelGenerator:
    ...
    def generate_model(self):
        ...
        """
        fields = {
            d.field: (d.field_type, Field(default=d.field_value, alias=d.field_alias, exclude=d.field_exclude)) for d in
            self._model_def
        }
...
StableDiffusionImg2ImgProcessingAPI = PydanticModelGenerator(
    ...
    StableDiffusionProcessingImg2Img,
    [{"key": "sampler_index", "type": str, "default": "Euler"}, {"key": "init_images", "type": list, "default": None},
     {"key": "denoising_strength", "type": float, "default": 0.75}, {"key": "mask", "type": str, "default": None},
...
class ExtrasBaseRequest(BaseModel):
    resize_mode: Literal[0, 1] = Field(default=0, title="Resize Mode",
    ...
    show_extras_results: bool = Field(default=True, title="Show results",
    ...
    upscaling_resize: float = Field(default=2, title="Upscaling Factor", ge=1, le=4,
...
class ProgressRequest(BaseModel):
    skip_current_image: bool = Field(default=False, title="Skip current image",
