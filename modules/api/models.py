...
class FaceIDItem(BaseModel):
    ...
    rank: float = Field(title="Rank", default=128, ge=4, le=256, description="Rank to use, must be between 0 and 1.")
    override_sampler: bool = Field(title="Override Sampler", default=True, description="Should the sampler be overriden?")
    tokens: int = Field("Tokens", default=4, ge=1, le=16, description="Amount of tokens to use")
