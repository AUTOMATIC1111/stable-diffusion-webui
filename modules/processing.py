...
class ProcessedImage:
    ...
    def get_filename(self):
        ...
        if self.is_grid:
            unsaved_dir = opts.outdir_unsaved_grids
        else:
            unsaved_dir = opts.outdir_unsaved_samples
    ...
    def save(self, fn):
        if self.infotext_extras is not None:
            existing_info, info = self.infotext_extras
