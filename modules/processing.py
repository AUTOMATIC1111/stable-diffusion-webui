    ...
    with torch.no_grad(), p.sd_model.ema_scope():
        ...
        for n in range(p.n_iter):
            ...
            for i, x_sample in enumerate(x_samples_ddim):
                ...
                if p.restore_faces:
                    if opts.save and not p.do_not_save_samples and opts.save_images_before_face_restoration and not state.discarded:
                ...
                if p.color_corrections is not None and i < len(p.color_corrections):
                    if opts.save and not p.do_not_save_samples and opts.save_images_before_color_correction and not state.discarded:
                ...
                if opts.samples_save and not p.do_not_save_samples and not state.discarded:
