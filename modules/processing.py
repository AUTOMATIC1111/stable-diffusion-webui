...
class StableDiffusionProcessing:
    ...
    def __init__(self, sd_model=None, outpath_samples=None, outpath_grids=None, prompt: str = "",
                 ...
                 sampler_index: int = None, script_args: list = None, outpath_scripts: str = None):
...
def process_images_inner(p: StableDiffusionProcessing) -> Processed:
    ...
    if sd_models.user_embedding_dirs:
        ...
        for embedding_dir in sd_models.user_embedding_dirs:
            model_hijack.embedding_db.add_embedding_dir(embedding_dir)
