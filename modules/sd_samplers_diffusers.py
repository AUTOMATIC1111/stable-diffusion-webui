...
samplers_data_diffusers = [
    ...
    sd_samplers_common.SamplerData('DPM++ 2M SDE', lambda model: DiffusionSampler('DPM++ 2M SDE', DPMSolverSDEScheduler, model), [], {}),
    ...
    sd_samplers_common.SamplerData('DPM++ 2M SDE Karras', lambda model: DiffusionSampler('DPM++ 2M SDE Karras', DPMSolverSDEScheduler, model, use_karras_sigmas=True), [], {}),
