...
parser.add_argument("--update-all-extensions", action='store_true', help="update all extensions")
parser.add_argument("--skip-python-version-check", action='store_true', help="skip python version check - do not post bug reports if automatic1111 breaks")
