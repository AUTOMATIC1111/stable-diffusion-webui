...
device_hat: torch.device = None
device_dat: torch.device = None
device_srformer: torch.device = None
device_grl: torch.device = None
device_omnisr: torch.device = None
device_span: torch.device = None
device_compact: torch.device = None
