...
def sample_to_image(samples):
    x_sample = shared.sd_model.decode_first_stage(
        samples[0:1].type(shared.sd_model.dtype)
    )[0]
...
ldm.models.diffusion.ddim.tqdm = lambda *args, desc=None, **kwargs: extended_tdqm(
    *args, desc=desc, **kwargs
)
ldm.models.diffusion.plms.tqdm = lambda *args, desc=None, **kwargs: extended_tdqm(
    *args, desc=desc, **kwargs
)
...
class VanillaStableDiffusionSampler:
    ...
    def sample_img2img(
        self, p, x, noise, conditioning, unconditional_conditioning, steps=None
    ):
...
class KDiffusionSampler:
    ...
    def initialize(self, p):
        ...
        if hasattr(k_diffusion.sampling, "trange"):
            k_diffusion.sampling.trange = lambda *args, **kwargs: extended_trange(
                self, *args, **kwargs
            )
