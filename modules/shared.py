...
parser.add_argument("--extension-index", type=str, help="Extension index url", default="https://raw.githubusercontent.com/wiki/AUTOMATIC1111/stable-diffusion-webui/Extensions-index.md")
