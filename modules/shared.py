...
options_templates.update(options_section(('extra_networks', "Extra Networks"), {
    ...
    "extra_networks_card_width": OptionInfo(0, "Card width for Extra Networks (px) - (0 as default)"),
    "extra_networks_card_height": OptionInfo(0, "Card height for Extra Networks (px)"),
    "extra_networks_advanced_card_width": OptionInfo(0, "Card width for Extra Networks (px) - Advanced View"),
    "extra_networks_advanced_card_height": OptionInfo(0, "Card width for Extra Networks (px) - Advanced View"),
