...
parser.add_argument("--no-gradio-queue", action='store_false', dest="gradio_queue", help="Disables gradio queue; causes the webpage to use http requests instead of websockets; was the default in earlier versions")
