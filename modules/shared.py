...
parser.add_argument("--config", type=str, default="v1-inference.yaml", help="path to config which constructs model",)
...
weight_load_location = None if cmd_opts.lowram else devices.get_optimal_device()
