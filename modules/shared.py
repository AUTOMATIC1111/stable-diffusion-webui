...
options_templates.update(options_section(('upscaling', "Upscaling"), {
    ...
    "realesrgan_enabled_models": OptionInfo(["R-ESRGAN 4x+", "R-ESRGAN 4x+ Anime6B"],
                                            ...
                                            gr.CheckboxGroup, lambda: {"choices": realesrgan_models_names()}),
...
options_templates.update(options_section(('sd', "Stable Diffusion"), {
    ...
    "initial_noise_multiplier": OptionInfo(1.0, "Noise multiplier for img2img", gr.Slider,
                                           {"minimum": 0.5, "maximum": 1.5, "step": 0.01}),
    "img2img_color_correction": OptionInfo(False,
    ...
    "comma_padding_backtrack": OptionInfo(20,
                                          ...
                                          gr.Slider, {"minimum": 0, "maximum": 74, "step": 1}),
    ...
    "random_artist_categories": OptionInfo([],
                                           ...
                                           gr.CheckboxGroup, {"choices": artist_db.categories()}),
}))
...
options_templates.update(options_section(('ui', "User interface"), {
    ...
    "js_modal_lightbox_initially_zoomed": OptionInfo(True,
