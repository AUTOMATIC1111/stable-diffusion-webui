...
prompt_celebrities = modules.prompt_gen.load_promptgen('cfg/promptgen/celebrity.csv')
prompt_clothes = modules.prompt_gen.load_promptgen('cfg/promptgen/clothing.csv')
...
prompt_emotions = modules.prompt_gen.load_promptgen('cfg/promptgen/emotion.csv')
...
prompt_hairstyles = modules.prompt_gen.load_promptgen('cfg/promptgen/hairstyle.csv')
...
prompt_sports = modules.prompt_gen.load_promptgen('cfg/promptgen/sport.csv')
...
prompt_vehicles = modules.prompt_gen.load_promptgen('cfg/promptgen/vehicle.csv')
