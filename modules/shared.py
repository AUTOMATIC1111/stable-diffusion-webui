...
# keep these imports for backwards compatability for any module/extension using modules.shared instead of modules.paths
# (don't worry about linter showing they're unused)
