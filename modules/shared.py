...
options_templates.update(options_section(('extra_networks', "Extra Networks"), {
    "extra_networks_default_view": OptionInfo("cards", "Default view for Extra Networks", gr.Dropdown, {"choices": ["cards", "thumbs", "advanced"]}),
    "extra_networks_default_multiplier": OptionInfo(1.0, "Multiplier for extra networks", gr.Slider, {"minimum": 0.0, "maximum": 1.0, "step": 0.01}),
    "extra_networks_card_width": OptionInfo(0, "Card width for Extra Networks (px) - (Set 0 as default)"),
    "extra_networks_card_height": OptionInfo(0, "Card height for Extra Networks (px)"),
    "extra_networks_advanced_card_width": OptionInfo(0, "Card width for Extra Networks (px) - Advanced View"),
    "extra_networks_advanced_card_height": OptionInfo(0, "Card height for Extra Networks (px) - Advanced View"),
    "extra_networks_advanced_card_image_width": OptionInfo(0, "Card left section image width (px) - Advanced View"),
