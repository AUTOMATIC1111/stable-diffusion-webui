...
options_templates.update(options_section(('extra_networks', "Extra Networks"), {
    ...
    "extra_networks_advanced_card_width": OptionInfo(0, "[Advanced View] Card width (px) - (0 = Default)"),
    "extra_networks_advanced_card_height": OptionInfo(0, "[Advanced View] Card height (px) - (0 = Default)"),
    "extra_networks_advanced_card_image_width": OptionInfo(0, "[Advanced View] Card - image width (px) - (0 = Default)"),
