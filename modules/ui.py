    ...
    with gr.Blocks(analytics_enabled=False) as extras_interface:
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Group():
                    extras_upscalers_1 = gr.CheckboxGroup(label='Upscaler 1', elem_id="extras_upscalers_1", choices=[x.name for x in shared.sd_upscalers], value=[shared.sd_upscalers[0].name], type="index")
