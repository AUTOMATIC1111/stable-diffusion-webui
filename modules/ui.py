...
def create_toprow(is_img2img):
    ...
    return prompt, roll, prompt_style, negative_prompt, prompt_style2, submit, button_interrogate, button_deepbooru, prompt_style_apply, save_style, paste, clear, token_counter, token_button
