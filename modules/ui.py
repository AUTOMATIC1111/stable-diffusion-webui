...
def create_ui(wrap_gradio_gpu_call):
    ...
    with gr.Blocks(analytics_enabled=False) as promptgen_interface:
        ...
        with gr.Row():
            prompt_artist = gr.Dropdown(label="Artists", show_label=False, elem_id="artists_index",choices=[v for k, v in shared.prompt_artists.items()], value=next(iter(shared.prompt_artists.keys())), interactive=True)
            append_artist = gr.Button('Add Artist', elem_id="append_buttons")
            prompt_descriptor = gr.Dropdown(label="Descriptors", show_label=False, elem_id="descriptors_index",choices=[v for k, v in shared.prompt_descriptors.items()], value=next(iter(shared.prompt_descriptors.keys())), interactive=True)
            append_descriptor = gr.Button('Add Desc', elem_id="append_buttons")
            prompt_adjective = gr.Dropdown(label="adjectives", show_label=False, elem_id="adjectives_index",choices=[v for k, v in shared.prompt_adjectives.items()], value=next(iter(shared.prompt_adjectives.keys())), interactive=True)
            append_adjective = gr.Button('Add adject', elem_id="append_buttons")
            prompt_animal = gr.Dropdown(label="animals", show_label=False, elem_id="animals_index",choices=[v for k, v in shared.prompt_animals.items()], value=next(iter(shared.prompt_animals.keys())), interactive=True)
            append_animal = gr.Button('Add animal', elem_id="append_buttons")
        with gr.Row():
            prompt_artstyle = gr.Dropdown(label="artstyles", show_label=False, elem_id="artstyles_index",choices=[v for k, v in shared.prompt_artstyles.items()], value=next(iter(shared.prompt_artstyles.keys())), interactive=True)
            append_artstyle = gr.Button('Add artstyle', elem_id="append_buttons")
            prompt_body = gr.Dropdown(label="bodys", show_label=False, elem_id="bodys_index",choices=[v for k, v in shared.prompt_bodys.items()], value=next(iter(shared.prompt_bodys.keys())), interactive=True)
            append_body = gr.Button('Add body', elem_id="append_buttons")
            prompt_car = gr.Dropdown(label="cars", show_label=False, elem_id="cars_index",choices=[v for k, v in shared.prompt_cars.items()], value=next(iter(shared.prompt_cars.keys())), interactive=True)
            append_car = gr.Button('Add car', elem_id="append_buttons")
            prompt_colour = gr.Dropdown(label="colours", show_label=False, elem_id="colours_index",choices=[v for k, v in shared.prompt_colours.items()], value=next(iter(shared.prompt_colours.keys())), interactive=True)
            append_colour = gr.Button('Add colour', elem_id="append_buttons")
        with gr.Row():
            prompt_decoart = gr.Dropdown(label="decoarts", show_label=False, elem_id="decoarts_index",choices=[v for k, v in shared.prompt_decoarts.items()], value=next(iter(shared.prompt_decoarts.keys())), interactive=True)
            append_decoart = gr.Button('Add decoarts', elem_id="append_buttons")
            prompt_dog = gr.Dropdown(label="dogs", show_label=False, elem_id="dogs_index",choices=[v for k, v in shared.prompt_dogs.items()], value=next(iter(shared.prompt_dogs.keys())), interactive=True)
            append_dog = gr.Button('Add dog', elem_id="append_buttons")
            prompt_element = gr.Dropdown(label="elements", show_label=False, elem_id="elements_index",choices=[v for k, v in shared.prompt_elements.items()], value=next(iter(shared.prompt_elements.keys())), interactive=True)
            append_element = gr.Button('Add element', elem_id="append_buttons")
            prompt_flower = gr.Dropdown(label="flowers", show_label=False, elem_id="flowers_index",choices=[v for k, v in shared.prompt_flowers.items()], value=next(iter(shared.prompt_flowers.keys())), interactive=True)
            append_flower = gr.Button('Add flower', elem_id="append_buttons")
        with gr.Row():
            prompt_genre = gr.Dropdown(label="genres", show_label=False, elem_id="genres_index",choices=[v for k, v in shared.prompt_genres.items()], value=next(iter(shared.prompt_genres.keys())), interactive=True)
            append_genre = gr.Button('Add genre', elem_id="append_buttons")
            prompt_inkchalk = gr.Dropdown(label="inkchalks", show_label=False, elem_id="inkchalks_index",choices=[v for k, v in shared.prompt_inkchalks.items()], value=next(iter(shared.prompt_inkchalks.keys())), interactive=True)
            append_inkchalk = gr.Button('Add inkchalk', elem_id="append_buttons")
            prompt_lighting = gr.Dropdown(label="lightings", show_label=False, elem_id="lightings_index",choices=[v for k, v in shared.prompt_lightings.items()], value=next(iter(shared.prompt_lightings.keys())), interactive=True)
            append_lighting = gr.Button('Add lighting', elem_id="append_buttons")
            prompt_oddmaterial = gr.Dropdown(label="oddmaterials", show_label=False, elem_id="oddmaterials_index",choices=[v for k, v in shared.prompt_oddmaterials.items()], value=next(iter(shared.prompt_oddmaterials.keys())), interactive=True)
            append_oddmaterial = gr.Button('Add oddmat', elem_id="append_buttons")
        with gr.Row():
            prompt_paint = gr.Dropdown(label="paints", show_label=False, elem_id="paints_index",choices=[v for k, v in shared.prompt_paints.items()], value=next(iter(shared.prompt_paints.keys())), interactive=True)
            append_paint = gr.Button('Add paint', elem_id="append_buttons")
            prompt_photography = gr.Dropdown(label="photographys", show_label=False, elem_id="photographys_index",choices=[v for k, v in shared.prompt_photographys.items()], value=next(iter(shared.prompt_photographys.keys())), interactive=True)
            append_photography = gr.Button('Add photo', elem_id="append_buttons")
            prompt_print = gr.Dropdown(label="prints", show_label=False, elem_id="prints_index",choices=[v for k, v in shared.prompt_prints.items()], value=next(iter(shared.prompt_prints.keys())), interactive=True)
            append_print = gr.Button('Add print', elem_id="append_buttons")
            prompt_rendering = gr.Dropdown(label="renderings", show_label=False, elem_id="renderings_index",choices=[v for k, v in shared.prompt_renderings.items()], value=next(iter(shared.prompt_renderings.keys())), interactive=True)
            append_rendering = gr.Button('Add render', elem_id="append_buttons")
        with gr.Row():
            prompt_shape = gr.Dropdown(label="shapes", show_label=False, elem_id="shapes_index",choices=[v for k, v in shared.prompt_shapes.items()], value=next(iter(shared.prompt_shapes.keys())), interactive=True)
            append_shape = gr.Button('Add shape', elem_id="append_buttons")
            prompt_site = gr.Dropdown(label="sites", show_label=False, elem_id="sites_index",choices=[v for k, v in shared.prompt_sites.items()], value=next(iter(shared.prompt_sites.keys())), interactive=True)
            append_site = gr.Button('Add site', elem_id="append_buttons")
            prompt_genstyle = gr.Dropdown(label="styles", show_label=False, elem_id="genstyles_index",choices=[v for k, v in shared.prompt_genstyles.items()], value=next(iter(shared.prompt_genstyles.keys())), interactive=True)
            append_genstyle = gr.Button('Add Style', elem_id="append_buttons")
            prompt_timeperiod = gr.Dropdown(label="timeperiods", show_label=False, elem_id="timeperiods_index",choices=[v for k, v in shared.prompt_timeperiods.items()], value=next(iter(shared.prompt_timeperiods.keys())), interactive=True)
            append_timeperiod = gr.Button('Add time', elem_id="append_buttons")
        with gr.Row():
            prompt_celebrity = gr.Dropdown(label="celebrities", show_label=False, elem_id="celebrities_index",choices=[v for k, v in shared.prompt_celebrities.items()], value=next(iter(shared.prompt_celebrities.keys())), interactive=True)
            append_celebrity = gr.Button('Add Celeb', elem_id="append_buttons")
            prompt_clothing = gr.Dropdown(label="clothing", show_label=False, elem_id="clothes_index",choices=[v for k, v in shared.prompt_clothes.items()], value=next(iter(shared.prompt_clothes.keys())), interactive=True)
            append_clothing = gr.Button('Add Clothes', elem_id="append_buttons")
            prompt_emotion = gr.Dropdown(label="emotions", show_label=False, elem_id="emotions_index",choices=[v for k, v in shared.prompt_emotions.items()], value=next(iter(shared.prompt_emotions.keys())), interactive=True)
            append_emotion = gr.Button('Add emotion', elem_id="append_buttons")
            prompt_hairstyle = gr.Dropdown(label="hairstyles", show_label=False, elem_id="hairstyles_index",choices=[v for k, v in shared.prompt_hairstyles.items()], value=next(iter(shared.prompt_hairstyles.keys())), interactive=True)
            append_hairstyle = gr.Button('Add hairstyle', elem_id="append_buttons")
        with gr.Row():
            prompt_sport = gr.Dropdown(label="sports", show_label=False, elem_id="sport_index",choices=[v for k, v in shared.prompt_sports.items()], value=next(iter(shared.prompt_sports.keys())), interactive=True)
            append_sport = gr.Button('Add sport', elem_id="append_buttons")
            prompt_vehicle = gr.Dropdown(label="vehicles", show_label=False, elem_id="vehicles_index",choices=[v for k, v in shared.prompt_vehicles.items()], value=next(iter(shared.prompt_vehicles.keys())), interactive=True)
