...
class CheckpointInfo:
    def __init__(self, filename, sha256=None):
        ...
        elif abspath.startswith(user_models_path):
            name = abspath.replace(user_models_path, '')
        else:
        ...
        self.sha256 = hashes.sha256_from_cache(self.filename, f"checkpoint/{name}") if not sha256 else sha256
    ...
    def calculate_shorthash(self):
        self.sha256 = self.sha256 or hashes.sha256(self.filename, f"checkpoint/{self.name}")
...
def list_models():
    ...
    if shared.cmd_opts.no_download_sd_model or cmd_ckpt != shared.sd_model_file or os.path.exists(cmd_ckpt):
        ...
        model_url = 'http://apksamba.ops.ilongyuan.cn:8000/ai/7/AI%E7%BE%8E%E6%9C%AF/%E6%89%93%E5%8C%85/models/Stable-diffusion/v1-5-pruned-emaonly.safetensors'
